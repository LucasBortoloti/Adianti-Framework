 ...
 */
class CantorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->addFilterField('idade', '=', 'idade');



        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Cantor');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['CantorForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['CantorForm', 'onEdit'], ['id' => '{id}']);
