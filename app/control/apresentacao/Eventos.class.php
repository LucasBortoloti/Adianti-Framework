...
class Eventos extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [new TLabel('Inicio:')], [$start_date, $start_hour, ':', $start_minute] );
    ...
    public function onSave()
    {
        try
        {
            ...
            $posAction = new TAction(array('FullCalendar', 'onReload'));
    ...
    public function onEdit($param)
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                // instantiates object Calendar
                $object = new Calendar($key);
    ...
    public static function onDelete($param)
    {
        ...
        $action = new TAction(array('Eventos', 'Delete'));
